...
var B_MAX = 1e6;
var EDGE = 1e-3;
var mean = (p) => p.b * Math.exp(import_jstat.default.gammaln(1 + 1 / p.a) + import_jstat.default.gammaln(p.b) - import_jstat.default.gammaln(1 + 1 / p.a + p.b));
function solveAForMean(target, b) {
  const f = (a) => import_jstat.default.kumaraswamy.mean(a, b) - target;
  const flow = f(A_MIN);
  const fhigh = f(A_MAX);
...
var F = {
  ...
  pdf(p, x) {
    if (x <= 0 || x >= 1) return 0;
    return import_jstat.default.kumaraswamy.pdf(x, p.a, p.b);
  },
  handles: [
    {
      kind: "center",
    ...
    },
    {
      ...
      color: "#8b5cf6",
      lineCls: "miqr",
      at: (p) => import_jstat.default.kumaraswamy.inv(0.25, p.a, p.b),
      chip: () => "q25",
    ...
    },
    {
      ...
      color: "#8b5cf6",
      lineCls: "miqr",
      at: (p) => import_jstat.default.kumaraswamy.inv(0.75, p.a, p.b),
      chip: () => "q75",
...
var kumaraswamy_default = createWidget(F, { pins: "both" });
export {
  kumaraswamy_default as default
};

...
var F2 = {
  ...
  tip(p) {
    return `${F2.label} \u2022 drag mean line to reposition \u2022 drag \u25A0 to reshape \u2022 mu=${fmt(p.mu)} sigma=${fmt(p.sigma)}`;
  }
};
var normal_default = createWidget(F2, { pins: "none" });
export {
  normal_default as default
};

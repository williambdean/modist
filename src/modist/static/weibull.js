  ...
  "node_modules/jstat/dist/jstat.js"(exports, module) {
    (function(window, factory) {
      ...
      (function(jStat3, Math2) {
        ...
        jStat3.median = function median2(arr) {
      ...
      (function(jStat3, Math2) {
        ...
        jStat3.extend(jStat3.beta, {
          ...
          median: function median2(alpha, beta) {
        ...
        jStat3.extend(jStat3.pareto, {
          ...
          median: function median2(scale, shape) {
      ...
      (function(jStat3, Math2) {
        ...
        jStat3.extend({
          ...
          tukeyhsd: function tukeyhsd(arrays) {
            var sd2 = jStat3.pooledstdev(arrays);
            ...
            for (var i = 0; i < arrays.length; ++i) {
              for (var j = i + 1; j < arrays.length; ++j) {
                var p = jStat3.qtest(means[i], means[j], arrays[i].length, arrays[j].length, sd2, n, arrays.length);
                results.push([[i, j], p]);
              }
            }
            return results;
...
var B_MAX = 1e6;
var LN2 = Math.LN2;
var mean = (p) => p.beta * import_jstat.default.gammafn(1 + 1 / p.alpha);
var sd = (p) => {
  const g1 = import_jstat.default.gammafn(1 + 1 / p.alpha);
  const g2 = import_jstat.default.gammafn(1 + 2 / p.alpha);
  return p.beta * Math.sqrt(g2 - g1 * g1);
};
var median = (p) => p.beta * Math.pow(LN2, 1 / p.alpha);
var F = {
  name: "weibull",
  label: "Weibull",
  ...
  pdf(p, x) {
    if (x <= 0) return 0;
    return import_jstat.default.weibull.pdf(x, p.beta, p.alpha);
  },
  handles: [
    {
      kind: "center",
...
var weibull_default = createWidget(F, { pins: "left" });
export {
  weibull_default as default
};
